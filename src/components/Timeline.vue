  ...
  <div
    ...
    <div class="relative transition-all duration-700"
      ...
      <div class="absolute bottom-0 right-2 z-50 pointer-events-auto">
        <a href="https://gauravjiandani.com/Gaurav_Jiandani_CV.pdf" download target="_blank" rel="noopener" tabindex="0"
      ...
      <div class="flex items-center justify-between px-2 py-2 sm:px-4  transition-all duration-500"
        ...
        <h3 class="text-[22px] sm:text-4xl font-semibold text-blue-600 animate-fadeIn" style="animation-delay: 0.3s;">
          Timeline</h3>
        <img
      ...
      <!-- Date Card -->
      <div class="relative h-[10rem] sm:h-[15rem] overflow-hidden">
        ...
        <div class="relative flex items-center justify-center h-full px-2 pointer-events-none" style="z-index: 1000;">
          <div
            class="text-3xl sm:text-5xl text-white font-bold mr-4 sm:mr-6 animate-pulse transition-all duration-500 hover:scale-110">
            {{ todayDate }}
          </div>
          <div class="text-white transition-all duration-700"
            ...
            <div class="text-xs sm:text-sm uppercase tracking-wide opacity-90 animate-slideInRight"
              style="animation-delay: 0.8s;">{{ todayMonth }} {{ todayYear }}</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- Timeline -->
    <div class="px-2 sm:px-6 py-4 sm:py-6 transition-all duration-700"
                ...
                <template v-else>
                  <div class="w-full h-full rounded-full flex items-center justify-center">
                    <div class="w-2 h-2 bg-white rounded-full animate-ping"
                      :style="{ animationDelay: `${1 + i * 200}ms` }"></div>
                  </div>
                </template>
              </div>
